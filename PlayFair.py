...
original_key = newKey(keyLength)
print(' '.join(original_key[i:i+matrixSize]
      for i in range(0, len(original_key), matrixSize)))
encoded = encodeMessage(tj, original_key)
decoded = decodeMessage(encoded, original_key)
...
while True:
    ...
    attackEvo(encoded)
>>>>>>> d2bbaefe59fee43650b6327d07c969d10e830a40
